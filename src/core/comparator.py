...
from .hasher import hamming_distance, hashes_are_similar
...
class DuplicateGroup:
    ...
    def get_original(self, strategy: str = "oldest") -> Optional[FileMetadata]:
        """
    ...
    def group_by_perceptual_hash(self, files: List[FileMetadata]) -> List[DuplicateGroup]:
        ...
        for i, path1 in enumerate(paths):
            ...
            for path2 in paths[i + 1:]:
                ...
                if meta1.phash and meta2.phash:
                    if hashes_are_similar(meta1.phash, meta2.phash, self.similarity_threshold):
                        union(path1, path2)
